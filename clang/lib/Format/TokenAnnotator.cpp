    ...
    bool TokenAnnotator::CheckIfDatatype(FormatToken* token) {
        ...
        while (Next != nullptr && Next->isNot(tok::semi)) {
            ...
            */
            ...
            /*
            * if not identifier or simple datatype
            * then return false
            * e.g.
            ...
            */
            ...
            /*
            * if two DatatypeInner are present
            * and next token is '(' or '[' or ';'
            * then return true;
            *
            * if const present
            ...
            */
            ...
            if (j == 2) {
                if (start_tok->is(tok::kw_operator))
                    isDT = true;
                if (has_const or Next->is(tok::l_paren) or Next->is(tok::l_brace) or Next->is(tok::equal) or Next->is(tok::semi) or Next->is(tok::l_square) or Next->is(tok::colon))
                    isDT = true;
                break;
            }
        }
